...
public class LocalVisitorsMedicalInsurancePurchased {

    Boolean isPageLoad(WebDriver obj){
        return obj.findElement(By.id("mainHeadNav")).getText().contains("VISITOR INSURANCE EVALUATION");
    }

    Boolean verifyQuestionOne(WebDriver obj){
    ...
    Boolean verifyQuestionTwo(WebDriver obj){
    ...
    Boolean verifyQuestionThree(WebDriver obj){
    ...
    Boolean submitFeedback(WebDriver obj) throws InterruptedException {
